...
public class LcEvaluationResult {
	...
	public LcEvaluationResult(String validationMessage) {
		super();
		this.validationMessage = validationMessage;
	}

	public LcEvaluationResult() {
		super();
	}
	...
	public boolean equals(Object o) {
		...
		if (o == null || getClass() != o.getClass())
			return false;
		LcEvaluationResult that = (LcEvaluationResult) o;
	...
	public LcEvaluationResult(String name, String status, String validationMessage, String referenceData) {
		super();
		this.name = name;
		this.status = status;
		this.validationMessage = validationMessage;
	...
	public String toString() {
		return "LcEvaluationResult [name=" + name + ", status=" + status + ", validationMessage=" + validationMessage
